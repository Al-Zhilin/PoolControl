...
> [!CAUTION]
> При монтаже электрической части при риске попадания воды на оборудование следует позаботиться об их гидроизоляции во имя снижения риска случайного замыкания и/или удара током! В частности можно использовать закрытую клемную коробку или ящик для электрооборудования.
